...
# CONFIG -----------------------------------------------------------------------------------------------------------#
ROOT = '/disk/scratch/avashna/Samsung/'
# Here are the input and output data paths (Note: you can override wav_path in preprocess.py)
wav_path = ROOT+'data/wavs_train/'
data_path = ROOT+'data/data/speaking_rate'
book_names = ['CB-JE', 'CB-EM', 'CB-FFM', 'CB-LCL']

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'blizzard_vocoder'
tts_model_id = 'blizzard_baseline_speaking_rate'
